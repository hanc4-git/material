...
{  
  ...
  G4Element* elPt = new G4Element("Platinum"   , "Pt", 78., 195.084*g/mole);
  G4Element* elI = new G4Element("Iodine", "I", 53., 126.904*g/mole);

  // define simple materials
  // define a material from elements.   case: chemical molecule
  G4Material* detector_mat = new G4Material("Semiconductor", 5.02*g/cm3, 3);
  detector_mat->AddElement(elCs, 2);
  detector_mat->AddElement(elPt, 1);
  detector_mat->AddElement(elI, 6);
